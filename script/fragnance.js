...
const similarPro1 = (q,s) =>{
	...
	headers: {
		...
		'X-RapidAPI-Key': '4f9e363397msh71f122a1b03bbb4p1febd9jsnb375811452ff'
...
similarPro1("fragrance","P_NEW%3A1");
similarPro2("fragrance","P_BEST_SELLING%3A1");
similarPro3("women perfume");
similarPro4("men perfume");
